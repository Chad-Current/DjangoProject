...
urlpatterns = [
    ...
    path('add/account/',              views.AccountVaultCreateView.as_view(),  name='vault_create_account'),
    path('add/device/',               views.DeviceVaultCreateView.as_view(),   name='vault_create_device'),
