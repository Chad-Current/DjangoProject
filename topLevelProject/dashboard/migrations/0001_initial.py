# Generated by Django 6.0.1 on 2026-01-13 19:38
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='account_categories', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(help_text='Account name or service', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('contact', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='emergency_notes', to='dashboard.contact')),
                ('profile', models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='emergency_notes', to='dashboard.profile')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='profile',
            field=models.ForeignKey(editable=False, on_delete=django.db.models.deletion.CASCADE, related_name='digital_accounts', to='dashboard.profile'),
        ),
        migrations.CreateModel(
            name='Device',
            fields=[
                ...
                ('unlock_method_description', models.TextField(blank=True, help_text='How to unlock (without revealing actual password)')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('target_account', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='recovery_requests', to='dashboard.digitalaccount')),
            ],
            options={
        ...
        migrations.AddIndex(
            model_name='digitalaccount',
            index=models.Index(fields=['profile', '-created_at'], name='digital_acc_profile_f2075f_idx'),
        ),
        migrations.AddIndex(
            model_name='digitalaccount',
            index=models.Index(fields=['category'], name='digital_acc_categor_31206a_idx'),
        ),
        migrations.AddIndex(
            model_name='contact',
