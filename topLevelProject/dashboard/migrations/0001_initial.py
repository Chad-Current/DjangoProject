# Generated by Django 6.0.1 on 2026-02-11 19:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('keep_or_close_instruction', models.CharField(choices=[('Keep Active', 'Keep Active'), ('Close Account', 'Close Account'), ('Memorialize', 'Memorialize'), ('Other (See Notes)', 'Other (See Notes)')], default='Other (See Notes)', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('body', models.CharField(blank=True, help_text='Emergency message content')),
        ...
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['profile', 'delegated_important_document_to'], name='important_d_profile_fcbc9f_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['profile', 'delegated_estate_to'], name='digital_est_profile_13de22_idx')],
            },
        ),
        migrations.CreateModel(
            name='Device',
            ...
            options={
                ...
                'indexes': [models.Index(fields=['profile', 'delegated_device_to'], name='devices_profile_e385a9_idx')],
            },
        ),
        migrations.AddIndex(
            model_name='account',
