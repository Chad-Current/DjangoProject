# Generated by Django 4.2.9 on 2026-02-01 20:13
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('estate_document', models.CharField(choices=[('Last Will and Testament', 'Directs distribution of assets, names executor, may name guardians for minor children.'), ('Revocable Living Trust', 'Holds property during life and distributes it after death, often avoiding probate.'), ('Financial Power of Attorney', 'Authorizes someone to manage finances if you are incapacitated.'), ('Health Care Power of Attorney', 'Authorizes someone to make medical decisions if you cannot.'), ('Living Will / Advance Directive', 'States your wishes for end-of-life or critical medical care.'), ('Beneficiary Designations', 'Forms for life insurance, retirement accounts, etc., naming who receives benefits.'), ('HIPAA Authorization', 'Allows named individuals to access your medical information.'), ('Letter of Instruction', 'Informal document with guidance for heirs, location of assets, and personal wishes.'), ('Insurance Policies', 'Life, disability, and other policies relevant to your estate and survivors.'), ('Property Deeds and Titles', 'Deeds, titles, and related ownership documents for real estate and vehicles.')], default='important_personal_documents', max_length=200)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.DateTimeField(default=django.utils.timezone.now)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('delegate_doc', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delegation_estate_doc', to='dashboard.digitalestatedocument')),
                ('delegate_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delegations_received', to='dashboard.contact')),
